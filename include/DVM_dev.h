...
DVM_array_set_object(DVM_VirtualMachine *dvm, DVM_ObjectRef barray, int index,
                     DVM_ObjectRef value, DVM_ObjectRef *exception_p);
int DVM_array_size(DVM_VirtualMachine *dvm, DVM_Object *barray);
void
DVM_array_resize(DVM_VirtualMachine *dvm, DVM_Object *barray, int new_size);
void DVM_array_insert(DVM_VirtualMachine *dvm, DVM_Object *barray, int pos,
                      DVM_Value value);
void DVM_array_remove(DVM_VirtualMachine *dvm, DVM_Object *barray, int pos);
