...
#define ARRAY_SIZE(barray)  (sizeof(barray) / sizeof((barray)[0]))
...
void dvm_dispose_executable_Ex(DVM_Executable *exe,int shouldFreeExe);
/* wchar.c */
...
extern DVM_Boolean dvm_compare_package_name(char *p1, char *p2);
extern char *
