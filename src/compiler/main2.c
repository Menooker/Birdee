...
extern void dump_function(int function_count, DVM_Function *function);
extern void dump_constant_pool(int constant_pool_count, DVM_ConstantPool *constant_pool);
