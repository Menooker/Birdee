...
int
dvm_conv_pc_to_line_number(DVM_Executable *exe, BFunction *func, int pc)
{
...
static void
error_v(DVM_Executable *exe, BFunction *func, int pc, RuntimeError id,
        va_list ap)
{
    VString     message;
    int         line_number;
...
void
dvm_error_i(DVM_Executable *exe, BFunction *func, int pc,
            RuntimeError id, ...)
{
    va_list     ap;
